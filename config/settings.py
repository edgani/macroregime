...
QUOTE_CACHE_TTL_SECONDS = int(os.getenv('MRP_QUOTE_CACHE_TTL_SECONDS', '90'))
QUOTE_UPDATE_BATCH_SIZE = int(os.getenv('MRP_QUOTE_UPDATE_BATCH_SIZE', '24'))
QUOTE_INTRADAY_PERIOD = os.getenv('MRP_QUOTE_INTRADAY_PERIOD', '5d').strip() or '5d'
QUOTE_INTRADAY_INTERVAL = os.getenv('MRP_QUOTE_INTRADAY_INTERVAL', '1m').strip() or '1m'
