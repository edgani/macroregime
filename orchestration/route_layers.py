    ...
    for mk, sec in sections.items():
        ...
        def add_row(row: dict, is_radar: bool, force_tail: bool = False) -> None:
            ...
            opp = {
                ...
                'signal_key': key,
                'ticker': str(row.get('ticker', row.get('name', ''))).strip(),
                ...
                'display_price_text': str(row.get('display_price_text', '') or ''),
                'price_as_of_text': str(row.get('price_as_of_text', '') or ''),
                'price_mode_badge': str(row.get('price_mode_badge', '') or ''),
                'price_source': str(row.get('price_source', '') or ''),
                'price_delay_note': str(row.get('price_delay_note', '') or ''),
