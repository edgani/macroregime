...
TESTS=[
 ...
 'tests/test_data_adapters.py','tests/test_macro_logic.py','tests/test_macro_snapshot.py','tests/test_replay_timestamps.py','tests/test_negative_controls.py','tests/test_fuzz.py','tests/test_walkforward.py'
]
results=[]
for rel in TESTS:
