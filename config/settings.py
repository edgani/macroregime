...
# ── FRED series ───────────────────────────────────────────────────────────────
FRED_GROWTH_SERIES   = {"INDPRO":"Industrial Production","RSAFS":"Retail Sales","PAYEMS":"Nonfarm Payrolls","UNRATE":"Unemployment","ICSA":"Initial Claims","HOUST":"Housing Starts"}
FRED_INFLATION_SERIES = {"CPIAUCSL":"CPI","CPILFESL":"Core CPI","PPIACO":"PPI","T5YIE":"5yr Breakeven","T10YIE":"10yr Breakeven","DFII10":"10yr TIPS"}
FRED_POLICY_SERIES   = {"FEDFUNDS":"Fed Funds","DFF":"Daily Fed Funds","M2SL":"M2 Money Supply"}

# ── GIP Weights (Hedgeye: RoC/momentum dominant) ─────────────────────────────
GROWTH_LEVEL_WEIGHTS  = {"indpro_yoy":0.22,"retail_yoy":0.20,"payrolls_yoy":0.18,"housing_yoy":0.12,"ism_norm":0.15,"unrate_inv":0.07,"claims_inv":0.06}
GROWTH_MOM_WEIGHTS    = {"indpro_roc":0.28,"retail_roc":0.22,"payrolls_roc":0.18,"ism_delta":0.14,"unrate_delta":0.10,"claims_delta":0.08}
INFLATION_LEVEL_WEIGHTS= {"cpi_yoy":0.28,"core_cpi_yoy":0.24,"breakeven_5y":0.18,"ppi_yoy":0.14,"oil_3m":0.10,"gold_3m":0.06}
INFLATION_MOM_WEIGHTS = {"cpi_roc":0.30,"core_cpi_roc":0.26,"breakeven_delta":0.18,"oil_1m":0.14,"dxy_inv_1m":0.12}

STRUCTURAL_WEIGHTS   = {"growth_level":0.20,"growth_momentum":0.40,"inflation_level":0.10,"inflation_momentum":0.30}
MONTHLY_WEIGHTS      = {"growth_level":0.15,"growth_momentum":0.50,"inflation_level":0.10,"inflation_momentum":0.50}
...
FOREX_PAIRS: dict = {
    ...
    # EM FX (critical for Hedgeye framework)
...
COMMODITIES: dict = {
    ...
    # Softs / Other
    "LBS=F":"Lumber",
    # Uranium (nuclear = AI power bottleneck)
...
IHSG_UNIVERSE: dict = {
    ...
    # Via Yahoo Finance (some may have limited history)
...
TICKER_SECTOR: dict = {
    ...
    # AI Optics / Photonics
    "LITE":"ai_optics","COHR":"ai_optics","CIEN":"ai_optics","POET":"ai_optics","VIAV":"ai_optics",
    "GLW":"ai_optics",  # Corning - fiber
    # AI Power (SiC/GaN)
    "ON":"sic_gan","WOLF":"sic_gan","STM":"sic_gan","IFNNY":"sic_gan",
    # AI Power Infrastructure
    "VST":"ai_power_infra","CEG":"ai_power_infra","ETN":"ai_power_infra",
    "NRG":"ai_power_infra","GEV":"ai_power_infra","EMR":"ai_power_infra",
    # AI Packaging
    ...
    "KTOS":"defense","HII":"defense","LDOS":"defense","BAH":"defense",
    # Utilities
    "NEE":"utilities","DUK":"utilities","D":"utilities","SO":"utilities","XLU":"utilities",
    # Water
    "AWK":"water","WTRG":"water","CWT":"water",
    # Precious Metals
    "GLD":"precious_metals","GC=F":"precious_metals","SLV":"precious_metals",
    "SI=F":"precious_metals","PPLT":"precious_metals","GFI":"precious_metals","NEM":"precious_metals",
    # Energy Infrastructure
    "XLE":"energy_infra","CL=F":"energy_infra","BZ=F":"energy_infra",
