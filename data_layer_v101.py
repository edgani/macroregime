"""Integrated V10.1 data plane: bundled research plus persistent current context."""
...
import current_context_v101 as current
...
def load_all(
    ...
    if allow_synthetic:
        raise ValueError("Synthetic evidence is forbidden in V10.1")
    ...
    base["sources"]["v101_current"] = {
        ...
        "official_policy_rates": int((now_context.get("official_policy_rates") or {}).get("record_count") or 0),
    }
