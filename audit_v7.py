...
check('desk schema version', desk['meta'].get('desk_schema_version')=='V7_NONBLOCKING_REFRESH_2026_07_18')
...
(ROOT/'V7_DEEP_RUNTIME_AUDIT.json').write_text(json.dumps(report,indent=2,default=str),encoding='utf-8')
