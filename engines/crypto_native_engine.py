...
def _setup_row(r, side: str):
    ...
    return {
        ...
        'invalidator': invalidation_from_row(r, side, 'funding panas / exchange inflow naik'),
        'risk': risk_label(r, side, high_vol=0.08),
        'setup_type': 'Healthy Expansion' if side == 'long' else 'Fragile / Distribution',
