...
checks = {
    ...
    'desk_schema_guard': 'V6_RICH_DYNAMIC_2026_07_18' in app and 'desk_schema_version' in run,
    ...
    'initial_header_is_research_only': 'v0.6 · LOADING' in html and 'RESEARCH ONLY · PAPER/LIVE BLOCKED' in html,
}
