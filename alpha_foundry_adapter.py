...
def minimal_desk(error: str | None = None) -> dict[str, Any]:
    ...
    return attach_alpha_foundry({
        "meta": {"generated": None, "source": "NO_DATA", "sources": {}, "fred_source": "NO_DATA", "universe_n": 0, "note": error or "Live data unavailable; research state still loaded.", "feeds_status": {}, "safe_fail_closed": True, "desk_schema_version": "V7_NONBLOCKING_REFRESH_2026_07_18"},
