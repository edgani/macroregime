"""Global five-market promotion gate consuming only V9.5 bound proof-run outputs."""
...
def evaluate_all(runs: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    for market in MARKETS:
        ...
        if not isinstance(run, dict):
            results[market] = {"trading_ready": False, "errors": ["V9.5 proof run missing"]}
    ...
    payload = {
        "schema": "warroom.v95.global_market_adjudication.v1",
