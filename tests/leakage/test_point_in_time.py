...
def test_future_release_is_excluded() -> None:
    rows = [PointInTimeObservation("CPI", datetime(2026, 6, 1, tzinfo=UTC), datetime(2026, 7, 10, tzinfo=UTC), 2.7), PointInTimeObservation("CPI", datetime(2026, 7, 1, tzinfo=UTC), datetime(2026, 8, 12, tzinfo=UTC), 2.5)]
...
def test_latest_available_vintage_wins_without_overwrite() -> None:
    rows = [PointInTimeObservation("GDP", datetime(2026, 1, 1, tzinfo=UTC), datetime(2026, 4, 1, tzinfo=UTC), 1.0, "advance"), PointInTimeObservation("GDP", datetime(2026, 1, 1, tzinfo=UTC), datetime(2026, 5, 1, tzinfo=UTC), 1.2, "second")]
