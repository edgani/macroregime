"""Fast, resilient official/public context collector for War Room OS V9.9.
...
DEFAULT_OUT = HERE / "runtime" / "v99_public_acquisition"
...
def collect(output: Path = DEFAULT_OUT) -> dict[str, Any]:
    ...
    payload = {
        "schema": "warroom.v99.public_context_acquisition.v1",
        "generated_at": _iso(),
    ...
    (root / "v99_public_acquisition_manifest.json").write_text(json.dumps(payload, indent=2), encoding="utf-8")
    return payload
